...
class RAGLLM_Prompt:
    ...
    3) طبیعی و روان بنویس.
    4) زبان پیش‌فرض: فارسی.
    5) این جمله را به انتهای تمام پاسخ ها اضافه کن: "در صورت عدم رضایت از پایگاه دانش لطفا از چت آزاد استفاده کنید"

    قالب پاسخ:
    - بصورت خلاصه (حداکثر 2 تا 3 جمله) پاسخ بده.
    - زبان پیش‌فرض: فارسی.
    - این جمله را به انتهای تمام پاسخ ها اضافه کن: "در صورت عدم رضایت از پایگاه دانش لطفا از چت آزاد استفاده کنید"
    """
